...
public abstract class BaseLazyFragment extends Fragment {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        Log.d("BaseLazyFragment", "setUserVisibleHint() -> isVisibleToUser: " + isVisibleToUser);
        if (rootView == null) {
            return;
        }
        hasCreateView = true;
    ...
    public void delToken() {
        SPUtils.put(getActivity(), PublicUrl.TOKEN_KEY, "");
    }
