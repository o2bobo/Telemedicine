...
public class DocSpecializedDialog extends BaseMenuDialog {
    ...
    private void getSpecialized() {
        mMenuList1.clear();
        RequestParams params = new RequestParams(BaseConst.DEAULT_URL + "/mobile/clinic/getDepartUnionByUserId?userId=" + mUserId);
        ...
        cancelable = x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                Log.i("test", "getSpecialized:" + result);
    ...
    private void getHospital(String itemCode) {
        RequestParams params = new RequestParams(BaseConst.DEAULT_URL + "/mobile/clinic/getSiteByDeparUnionId?unionId=" + itemCode);
        //params.setSslSocketFactory(); // 设置ssl
        params.addHeader("authorization", getTokenFromLocal());
        Callback.Cancelable cancelable;
        cancelable = x.http().get(params, new Callback.CommonCallback<String>() {
